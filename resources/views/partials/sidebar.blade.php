    ...
    <nav class="mt-10">
        ...
        @can('logged-in')
            @can('admin')
                ...
                <x-nav-link :href="route('admin.leavemanagement.index')" :active="request()->routeIs('admin.leavemanagement.index')">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <x-nav-link :href="route('admin.roles.index')" :active="request()->routeIs('admin.roles.index')">
                    ...
                    <span class="mx-3">{{ __('Role Management') }}</span>
                </x-nav-link>
