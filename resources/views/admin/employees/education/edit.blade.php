        ...
        <div class="block w-full overflow-x-auto px-6">
            {!! Form::open(['action' => ['App\Http\Controllers\Admin\EmployeeEducationsController@update', $empEducation->employee_id, $empEducation->id], 'method' => 'POST']) !!}
                ...
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-4/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            {!! Form::select('education', $educationTypes, $empEducation->education_types_id, ['class' => 'form-select block w-full mt-1 border-0 px-3 py-3 placeholder-blueGray-400 text-gray-600 bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150']) !!}
                    ...
                    <div class="w-full lg:w-8/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            {{ Form::text('course', $empEducation->course, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-400 text-gray-600 bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150', 'placeholder' => '']) }}
                    ...
                    <div class="w-full px-4">
                        <div class="relative w-full mb-3">
                            ...
                            {{ Form::text('school', $empEducation->institution, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-400 text-gray-600 bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150', 'placeholder' => '']) }}
                ...
                <div class="flex flex-wrap">
                    <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            {{ Form::date('start', $empEducation->startYear, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-400 text-gray-600 bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150', 'placeholder' => '']) }}
                    ...
                    <div class="w-full lg:w-6/12 px-4">
                        <div class="relative w-full mb-3">
                            ...
                            {{ Form::date('end', $empEducation->endYear, ['class' => 'border-0 px-3 py-3 placeholder-blueGray-400 text-gray-600 bg-gray-100 rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150', 'placeholder' => '']) }}
                ...
                <div class="w-full flex justify-end px-4 py-5">
                    <a href="{{ route('admin.employees.show', $empEducation->id) }}" class="btn btn-outline mt-3 w-full inline-flex justify-center sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm">
                        {{ __('Cancel') }}
                    </a>
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                        ...
                        <div class="mt-2">
                            <p class="text-sm text-gray-500">
                                {{ __('Are you sure you want to delete the record for course') }}
                                    <strong>{{ $empEducation->course }}</strong>
