        ...
        <div class="block w-full overflow-x-auto">
            <table class="items-center w-full bg-transparent border-collapse">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @foreach ($employees as $key => $department)
                        <tr>
                            ...
                            <td class="flex flex-wrap items-center p-4">
                                <a href="{{ route('admin.employees.show', $department->id) }}" class="flex items-center bg-teal-500 text-white active:bg-teal-600 font-bold uppercase text-xs px-2 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
