@if(count($errors) > 0)
    @foreach ($errors->all() as $error)
        <div class="flex w-full mt-8 mb-4">
            <div class="inline-flex max-w-md w-full bg-white shadow-md rounded-lg overflow-hidden relative mb-2 mr-3">
...
@if(session('success'))
    ...
    <div class="flex w-full mt-8 mb-4">
        <div class="flex max-w-md w-full bg-white shadow-md rounded-lg overflow-hidden relative mb-2 mr-3">
