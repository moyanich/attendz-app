@if(count($errors) > 0)
    @foreach ($errors->all() as $error)
        ...
        <div class="inline-flex  w-full bg-white shadow-md rounded-lg overflow-hidden relative  mb-4 mb-2 mr-3">
...
@if(session('success'))
    ...
    <div class="flex  w-full bg-white shadow-md rounded-lg overflow-hidden relative  mb-4 mb-2 mr-3">
